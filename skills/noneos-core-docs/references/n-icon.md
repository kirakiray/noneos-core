...
- **双重缓存机制**：
    ...
    - **持久化缓存**：基于 [EverCache](https://raw.githubusercontent.com/kirakiray/ever-cache/refs/heads/main/skills/ever-cache/SKILL.md) (IndexedDB) 存储已下载的图标，实现跨页面、跨会话的瞬间加载，显著减少网络请求。
